...
<header>
    <div id="headerContent" class="flex-container flex-wrap flex-center">
        ...
        <div class="flex-container flex-right flex-fill">
            ...
            <img id="cart" class="button-img" src='<?= "http://{$_SERVER["SERVER_NAME"]}:{$_SERVER["SERVER_PORT"]}/header/cart.png" ?>' alt="cart">
        </div>
    </div>
    <div id="headerPlaceholder"></div>
    <div id="cartDiv" class="hidden"></div>
</header>
<?php include "{$_SERVER["DOCUMENT_ROOT"]}/profile/cart.php"; ?>